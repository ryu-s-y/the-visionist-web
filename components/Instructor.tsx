        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-base text-gray-600 leading-loose break-keep">
              지난 20년간 국내 유수의 대기업과 공공기관에서 리더십과 조직문화
              혁신을 주도해왔습니다. 조직의 복잡성 속에서 성과X성장X즐거움의
              방법을 실용적으로 연구합니다. .
            </p>
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  <strong>現</strong> The Visionist(더 비저니스트) 대표
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 mt-2.5 rounded-full bg-brand-gold shrink-0"></div>
                <p className="text-gray-700 leading-relaxed">
                  <strong>現</strong> 한국생산성본부 전문교수
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 mt-2.5 rounded-full bg-brand-gold shrink-0"></div>
                <p className="text-gray-700 leading-relaxed">
                  <strong>前</strong> 행안부 정부혁신 컨설팅위원 (조직문화분과)
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 mt-2.5 rounded-full bg-brand-gold shrink-0"></div>
                <p className="text-gray-700 leading-relaxed">
                  <strong>前</strong> 명지전문대학 객원조교수
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 mt-2.5 rounded-full bg-brand-gold shrink-0"></div>
                <p className="text-gray-700 leading-relaxed">
                  <strong>前</strong> 현대자동차그룹 조직개발 사외 Facilitator
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 mt-2.5 rounded-full bg-brand-gold shrink-0"></div>
                <p className="text-gray-700 leading-relaxed">
                  <strong>前</strong> SK텔레콤 서비스에이스 교육사업본부 팀장
                </p>
              </div>
            </div>

            <div className="pt-6">
              <span className="text-brand-dark font-bold text-lg block mb-4">
                주요 강의 분야
              </span>
              <div className="flex flex-wrap gap-3">
                <span className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600 hover:border-brand-royal hover:text-brand-royal transition-colors">
                  리더십 코칭
                </span>
                <span className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600 hover:border-brand-royal hover:text-brand-royal transition-colors">
                  조직 활성화
