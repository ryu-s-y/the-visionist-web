...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-gradient-to-br from-white via-purple-50 to-brand-royal/10"
    >
      <div className="max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div ref={textRef} className="flex flex-col gap-8">
          ...
          <p className="text-base lg:text-lg text-gray-600 max-w-xl leading-loose break-keep">
            조직의 잠재력을 깨우는 비전 리더십과 혁신적인 사고. 더비저니스트는
            미래 리더를 위한 최상의 기업 교육 솔루션을 제공합니다.
          </p>
        ...
        >
          ...
          <div className="absolute inset-0 bg-white rounded-[2rem] shadow-2xl overflow-hidden border border-gray-100 transform -rotate-2 hover:rotate-0 transition-transform duration-500">
            <div className="w-full h-full bg-gray-50 flex items-center justify-center relative">
              ...
              <span className="text-brand-royal/20 text-8xl font-bold">
                Vision
              </span>
            </div>
          </div>
