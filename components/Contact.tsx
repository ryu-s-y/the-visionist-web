    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl lg:text-5xl font-bold mb-6 break-keep">
              조직의 변화를 시작하세요
            </h2>
            <p className="text-gray-300 text-lg mb-8 leading-loose break-keep">
              더비저니스트와 함께라면 가능합니다. 귀사의 비전과 목표에 맞춘
              최적의 교육 프로그램을 제안해 드립니다. 지금 바로 문의하세요.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:boravision@naver.com"
                    className="font-medium text-lg text-[#C5A059] hover:text-white transition-colors"
                  >
